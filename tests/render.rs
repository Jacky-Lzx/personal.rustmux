...
fn full_grid_has_explicit_rows_and_never_uses_newlines() {
    ...
    assert_eq!(
        frame(&screen),
        b"\x1b[?25l\x1b[0m\x1b[?2004l\x1b[?1l\x1b[1;1Habc\x1b[2;1Hdef\x1b[0m\x1b[2;3H\x1b[?25h"
    );
...
fn exact_style_encoding_resets_attributes_between_cells() {
    ...
    assert_eq!(frame(&screen), b"\x1b[?25l\x1b[0m\x1b[?2004l\x1b[?1l\x1b[1;1H\x1b[0;1;2;3;4;5;7;8;9;38;5;1;48;2;0;127;255mAB\x1b[0mC\x1b[0m\x1b[1;3H\x1b[?25h");
}
...
fn wide_leaders_and_suffixes_are_emitted_once() {
    ...
    assert_eq!(
        frame(&screen),
        "\x1b[?25l\x1b[0m\x1b[?2004l\x1b[?1l\x1b[1;1H中e\u{301}X\x1b[0m\x1b[1;4H\x1b[?25h"
            .as_bytes()
    );
}
